...
const PORT_SLUGS = {
  ...
  gibraltar:     'gibraltar',
  ajaccio:       'ajaccio-corsica-france',
  limassol:      'limassol-cyprus',
  tangier:       'tangier-morocco',
  argostoli:     'argostoli-kefalonia-greece',
  ashdod:        'ashdod-israel',
  larnaca:       'larnaca-cyprus',
  agadir:        'agadir-morocco',
  arrecife:      'arrecife-lanzarote-spain',
  'morro jable': 'morro-jable-fuerteventura-spain',
